...
{
    // TypeConverter that can convert to and from string and TValue
    ...
    // we need a non-generic intermediate converter that will create the
    // actual converter and delegate to it.
    public class StronglyTypedIdConverter : TypeConverter
    {
        ...
        private TypeConverter CreateActualConverter(Type stronglyTypedIdType)
        {
